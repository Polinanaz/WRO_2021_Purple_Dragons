  ...
  <div class="mes">
    ...
    <div class="center examplex">
      ...
      <div class="square">
        <vs-row>
          <vs-col w='6'>
            <div class="block-header-mes center-block">
              <div class="block-header-text__mes">
                <h1>Состояние МЧС</h1>
              </div>
            </div>
            <div class="block__mes center-block">
              <div class="block__content__mes">
                <br />
                <h2>Состояние подключения к сети: МЧС {{ mes.status }}</h2>
                <br />
                <h2>Заряд аккумулятора: {{ mes.battery }}</h2>
                <br />
                <h2>Количество доступной для МЧС воды: {{ mes.water }}</h2>
                <br />
                <h2>Текущее потребление МЧС: {{ mes.total_consumption }}</h2>
              </div>
            </div>
          </vs-col>
          <vs-col w='6'>
            <div class="block-header2-mes center-block">
              <div class="block-header2-text__mes">
                <h1>График</h1>
              </div>
            </div>
            <div class="block2__mes center-block">
              <div class="block__content_2__mes">
...
export default {
  ...
  mounted () {
    if (this.changeTheme) {
      ...
      let elem = document.getElementsByClassName('footer__mes')[0]
      elem.style.backgroundColor = '#1e1e1e'
      elem.style.color = '#ffffff'
      document.getElementsByClassName('block__mes')[0].style.backgroundColor = '#303030'
      document.getElementsByClassName('block__content__mes')[0].style.color = '#ffffff'
      document.getElementsByClassName('block2__mes')[0].style.backgroundColor = '#303030'
      document.getElementsByClassName('block__content_2__mes')[0].style.color = '#ffffff'
      document.getElementsByClassName('block-header-mes')[0].style.backgroundColor = '#242424'
      document.getElementsByClassName('block-header-text__mes')[0].style.color = '#ffffff'
      document.getElementsByClassName('block-header2-mes')[0].style.backgroundColor = '#242424'
      document.getElementsByClassName('block-header2-text__mes')[0].style.color = '#ffffff'
